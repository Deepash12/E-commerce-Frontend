          ...
          <>
            <div className="overflow-x-auto">
              <table className="w-full text-left min-w-[900px]">
                ...
                <tbody>
                  {products.map((p) => {
                    const imageSrc = getImageUrl(p.productImageUrl);
                    const imageFailed = failedImages[p.id];
                    ...
                    return (
                      ...
                      >
                        <td className="px-6 py-4">
                          {imageSrc && !imageFailed ? (
                            <img
                              ...
                              onLoad={() => {
                                console.log("List image loaded:", imageSrc);
                              }}
                              onError={(e) => {
                                console.log("List image failed:", e.currentTarget.src);
                        ...
                        <td className="px-6 py-4">
                          {p.discountPrice ? `₹${p.discountPrice}` : "N/A"}
                        </td>
