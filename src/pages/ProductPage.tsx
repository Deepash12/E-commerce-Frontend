...
const FadeIn: React.FC<{ index: number; children: React.ReactNode }> = ({
  index,
  children,
}) => (
  <div
...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  useEffect(() => {
    setWishlisted(Boolean(product.isWishlist));
    setImageError(false);
  }, [product]);
      ...
      >
        ...
        >
          {productImageSrc && !imageError ? (
            <img
              ...
              alt={product.name}
              onLoad={() => {
                console.log("Product card image loaded:", productImageSrc);
              }}
              onError={(e) => {
                console.log("Product card image failed:", e.currentTarget.src);
                setImageError(true);
              }}
              style={{
                width: "100%",
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
              <button
                ...
                style={{
                  ...
                  gap: 5,
                  background:
                    addHover && inStock ? "rgba(201,168,76,0.1)" : "transparent",
                  border: "1px solid rgba(201,168,76,0.3)",
                  color: !inStock
        ...
        <div
          style={{
            ...
            height: 2,
            background:
              "linear-gradient(90deg, transparent, #C9A84C 30%, #d4af37 50%, #C9A84C 70%, transparent)",
            opacity: hovered ? 1 : 0,
            transition: "opacity 0.4s ease",
          }}
        />
  ...
  >
    <div
      style={{
        height: 230,
        background:
          "linear-gradient(90deg, #151515 25%, #1e1e1e 50%, #151515 75%)",
        backgroundSize: "200% 100%",
        animation: "shimmer 1.6s infinite",
      }}
    />
...
const ProductsPage: React.FC = () => {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      console.log("Products list:", content);
  ...
  const handleSortChange = (idx: number) => {
    ...
    setFilters((f) => ({
      ...f,
      sortBy: opt.sortBy,
      sortDir: opt.sortDir as "asc" | "desc",
      pageNumber: 0,
    }));
  };
        ...
        >
          <div
            style={{
              ...
              height: 320,
              background:
                "radial-gradient(ellipse at center, rgba(201,168,76,0.07) 0%, rgba(201,168,76,0.02) 40%, transparent 70%)",
              pointerEvents: "none",
              animation: "glowPulse 5s ease-in-out infinite",
            }}
          />
          ...
          <div className="container-wide" style={{ position: "relative" }}>
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #a8873d 0%, #C9A84C 40%, #e8c96a 70%, #C9A84C 100%)",
              ...
              >
                ...
                <div
                  style={{
                    ...
                    margin: "0 20px",
                    background:
                      "linear-gradient(90deg, rgba(201,168,76,0.1), transparent)",
                  }}
                />
              </div>
